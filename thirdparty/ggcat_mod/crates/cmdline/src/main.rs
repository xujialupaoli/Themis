...
struct QueryArgs {
    ...
    #[structopt(flatten)]
    pub common_args: CommonArgs,
    /// Treat input reads as paired-end (indices 2n,2n+1 are mates).
    /// Default: paired, unless --single is given.
    #[structopt(long, conflicts_with = "single")]
    pub paired: bool,

    /// Treat input reads as single-end / long reads; no pairing enforced.
    #[structopt(long, conflicts_with = "paired")]
    pub single: bool,
